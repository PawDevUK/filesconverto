						...
						<div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
							...
							<div>
								...
								<ul className='space-y-1'>
									<li>
										<a className=' font-light text-sm ' href='/formats'>
											Formats
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/compression'>
											Compression
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/pricing'>
											Pricing
										</a>
									</li>
								</ul>
							...
							<div>
								...
								<ul className='space-y-1'>
									<li>
										<a className=' font-light text-sm ' href='/faq'>
											FAQ
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/status'>
											Status
										</a>
									</li>
								</ul>
							...
							<div>
								...
								<ul className='space-y-1'>
									<li>
										<a className=' font-light text-sm ' href='/api'>
											Developer API
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/tools'>
											Tools
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/blog'>
											Blog
										</a>
									</li>
								</ul>
							...
							<div>
								...
								<ul className='space-y-1'>
									...
									<li>
										<a className=' font-light text-sm ' href='/sustainability'>
											Sustainability
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/terms'>
											Terms of Service
										</a>
									</li>
									<li>
										<a className=' font-light text-sm ' href='/privacy'>
											Privacy
										</a>
									</li>
								</ul>
				...
				<div className='mt-8 pt-4 border-t border-gray-700'>
					<div className='text-center lg:text-left'>
						<small className='text-gray-400'>
							Copyright © 2006 - {new Date().getFullYear()} {companyName} <span className='hidden sm:inline'>-</span>{' '}
